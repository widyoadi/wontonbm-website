...
<main class="px-12 max-w-screen-xl">
  <p>
    Catatan sejarah menyebutkan bahwa sajian ini sudah ada sejak masa Dinasti Tang (618-906 M). Oleh masyarakat Tiongkok kuno, wonton hampir disamakan dengan jiaozi.
